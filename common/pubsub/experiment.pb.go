...
type Experiment struct {
	...
	Segments   map[string]*segmenters.ListSegmenterValue `protobuf:"bytes,6,rep,name=segments,proto3" json:"segments,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Type       Experiment_Type                           `protobuf:"varint,7,opt,name=type,proto3,enum=pubsub.Experiment_Type" json:"type,omitempty"`
	Interval   int32                                     `protobuf:"varint,8,opt,name=interval,proto3" json:"interval,omitempty"`
	Tier       Experiment_Tier                           `protobuf:"varint,9,opt,name=tier,proto3,enum=pubsub.Experiment_Tier" json:"tier,omitempty"`
	...
	Treatments []*ExperimentTreatment                    `protobuf:"bytes,12,rep,name=treatments,proto3" json:"treatments,omitempty"`
...
var file_api_proto_experiment_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x70, 0x75, 0x62, 0x73, 0x75,
	...
	0x65, 0x6e, 0x74, 0x73, 0x12, 0x2b, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01,
	...
	0x04, 0x74, 0x69, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x70, 0x75,
	...
	0x74, 0x72, 0x65, 0x61, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b,
